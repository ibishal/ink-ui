...
export const PlayerHUD: React.FC = () => {
  return (
    <div className="fixed top-0 left-0 w-full pt-8 pb-4 z-50 pointer-events-none">
      <div className="mx-auto w-full px-[10%] flex justify-between items-center pointer-events-none">
        ...
        <div className="flex gap-10 pointer-events-auto items-center">
          ...
          <button className="px-8 py-3 tactical-border bg-ink-pink text-[11px] font-black uppercase tracking-[0.2em] hover:bg-white hover:text-black transition-all shadow-[0_0_30px_rgba(230,0,122,0.15)] active:scale-95">
            Connect Wallet
          </button>
        </div>
      </div>
